...
export default function DressCodeSlider() {
  ...
  return (
    <div className="relative w-full max-w-lg mx-auto mt-12">
      {/* Photo */}
      <div className="relative aspect-[3/4] sm:aspect-[4/5] rounded-sm overflow-hidden bg-[#E8D9C0]">
        {imgError[current] ? (
        ...
        <button
          ...
          className="absolute left-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-white/70 backdrop-blur-sm flex items-center justify-center text-[#1C0A06] hover:bg-white transition-colors shadow-sm"
        >
        ...
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-white/70 backdrop-blur-sm flex items-center justify-center text-[#1C0A06] hover:bg-white transition-colors shadow-sm"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
